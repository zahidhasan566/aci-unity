        ...
        <div class="header">
            <div class="profile-header d-flex align-items-center flex-wrap">
                ...
                <div class="actions d-flex align-items-center gap-3 ms-auto">
                    ...
                    <div class="notification-icon position-relative" style="    margin-left: 10px;" @click="toggleNotification">
...
<!--                <div class="profile-icon">-->
<!--                    <img :src="`${mainOrigin}assets/icon/profile.png`" alt="profile Image" class="profile"></div> &lt;!&ndash; Profile icon placeholder &ndash;&gt;-->
<!--                <div class="greeting">-->
<!--                    <p class="time">Good Morning</p>-->
<!--                    <h1 class="name">Md Zahid Hasan</h1>-->
<!--                </div>-->
