    ...
    <div class="event-timeline">
        ...
        >
            <div class="timeline-marker">
                ...
                <div class="timeline-line" v-if="index !== hotel.length - 1"></div>
            </div>

            <div class="timeline-content">
                <h4 class="data-title">
                    <div class="row hotel-banner">
                        <div class="col-md-6 col-sm-6 col-7"> <span class="hotel-name">Hotel: {{ hotel.name }}</span></div>
                        <div style="text-align:right" class="col-md-6 col-sm-6 col-5"> <span class="room-number">Room: {{ hotel.room }}</span></div>
            ...
            hotels: [
                {
                    name: "Camp In Cox",
                    room: "523",
                    address: "Sayeman Beach Resort, 2nd Floor, Room 345",
                    date: "Monday, 27 July",
                    time: "09:00 - 10:00",
                },
                {
